...
```bash
mise run spec workflow orchestrated-handoff --feature tools/__tests__/fixtures/003-sync-frecency-preserve --next
mise run spec handoff-generate --feature tools/__tests__/fixtures/003-sync-frecency-preserve --focus gherkin
