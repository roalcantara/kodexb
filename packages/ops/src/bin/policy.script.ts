...
const EXPECTED_PUBLIC_TASKS = [
  ...
  [
    'validate-launcher-placement',
    'Electrobun bump gate: unit window specs + optional macOS desktop placement probe (KB_PLACEMENT_PROBE=1). Run after any electrobun version change.'
  ]
] as const
