...
const FIXTURE_PROFILE = path.resolve(
  import.meta.dir,
  '../../../packages/ops/src/__tests__/fixtures/workflow/fixture-profile.yaml'
)
const FIXTURE_TEARDOWN = path.resolve(
  import.meta.dir,
  '../../../packages/ops/src/__tests__/fixtures/workflow/fixture-profile-teardown.yaml'
)
