...
| `installBunDollarMock`, `setBunDollarThrow`, `setupBunDollarMock`           | Stub `Bun.$` for handoff/osascript specs (pair with `uninstallBunDollarMock`)                                                                                                       |
| `installBunSpawnSyncMock`, `setBunSpawnSyncResult`, `setupBunSpawnSyncMock` | Stub `Bun.spawnSync` for frontmost-app / spawn specs (pair with `uninstallBunSpawnSyncMock`)                                                                                        |
