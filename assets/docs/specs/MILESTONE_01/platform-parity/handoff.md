...
- [`entry-action-handoff/`](../../MILESTONE_01/entry-action-handoff) — normative handoff behavior
- [`electrobun-utils-adoption/`](../../MILESTONE_01/electrobun-utils-adoption) — Utils clipboard, cursor, quit
- [`shell-window-nav/`](../../MILESTONE_01/shell-window-nav) — window placement and chrome
- [`ci-review-e2e/`](../../MILESTONE_01/ci-review-e2e) — regression hard gate
