...
Ordered verification work for [`requirements.md`](../../MILESTONE_01/platform-parity/requirements.md) and
[`design.md`](../../MILESTONE_01/platform-parity/design.md). Check items only with command evidence in PR notes.

**Handoff prompt:** [`handoff.md`](../../MILESTONE_01/platform-parity/handoff.md)
...
- [x] **2.3** Update [`entry-action-handoff/design.md`](../../MILESTONE_01/entry-action-handoff/design.md) §Editor handoff with Linux adapter sentence (one paragraph addendum).
...
- [x] **4.1** macOS matrix (native `electrobun dev`):
  ...
  - Recorded in [`handoff.md` §Evidence](../../MILESTONE_01/handoff.md#evidence)

- [x] **4.2** Linux matrix (same flows):
  - **Blocked: no Linux host.** Documented in [`handoff.md` §Evidence](../../MILESTONE_01/handoff.md#evidence)
  - Expected evidence for future runner: xdotool version, terminal emulator, WM, gtk-launch desktop-id

- [x] **4.3** Update stale docs:
  - [`entry-action-handoff/design.md`](../../MILESTONE_01/entry-action-handoff/design.md) — editor Linux row changed to `gtk-launch`; paragraph updated
  - [`platform-parity/design.md`](../../MILESTONE_01/platform-parity/design.md) — parity matrix, drift table, stale bun_dollar path
  - [`platform-parity/handoff.md`](../../MILESTONE_01/platform-parity/handoff.md) — status, phases, audit summary
  - [`platform-parity/tasks.md`](../../MILESTONE_01/platform-parity/tasks.md) — checkboxes marked with command evidence
...
- [ ] **5.2** If metrics baseline stale after intentional suite growth, regenerate per
  [`e2e/design.md`](../../MILESTONE_01/e2e/design.md) with maintainer approval.
