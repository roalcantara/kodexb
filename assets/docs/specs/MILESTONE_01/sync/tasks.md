...
- **Work:**
  ...
  - Document files in [design.md § Fixture directory](../../MILESTONE_01/sync/design.md#testing-strategy).
...
- **Work:**
  - Add `SourceParseResult` + `parseSourceFileResilient` per
    [design.md § Parse API](../../MILESTONE_01/sync/design.md#parse-api-normative).
...
- **Work:**
  ...
  - Update [fixture-manifest.md](../../MILESTONE_01/e2e/fixture-manifest.md) § Sync resilience.
...
- **Requirements:** SY-5
- **Work:**
  - Implement steps from [step-catalog.md](../../MILESTONE_01/e2e/step-catalog.md) (§ Sync
...
- **Requirements:** —
- **Work:**
  - Add bullet under [assets/docs/specs/README.md](../../MILESTONE_01/README.md) feature index.
