...
[`sync-ui/design.md`](../../MILESTONE_01/sync-ui/design.md); this spec adds normative behavior
...
Each `## REQUIREMENT SY-N` maps to [design.md](../../MILESTONE_01/sync/design.md) and [tasks.md](../../MILESTONE_01/sync/tasks.md).
...
[`assets/docs/specs/README.md`](../../MILESTONE_01/README.md#verifiable-acceptance-no-orphan-checks).
...
Normative steps: [`e2e/step-catalog.md`](../../MILESTONE_01/e2e/step-catalog.md) (§ Sync resilience, § Sync modal error UX).

Fixture manifest additions: [`e2e/fixture-manifest.md`](../../MILESTONE_01/e2e/fixture-manifest.md)
