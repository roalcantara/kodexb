...
- [`sync-ui`](../../MILESTONE_01/sync-ui/design.md) — UI only; must show errors from this pipeline.
- [`data-layer`](../../MILESTONE_01/data-layer/design.md) — Update `mixed_invalid.yml` expected behavior when implementation matches SY-3.
- [`foundation/design.md`](../../MILESTONE_01/foundation/design.md) — Import remains shell concern, not renderer.
