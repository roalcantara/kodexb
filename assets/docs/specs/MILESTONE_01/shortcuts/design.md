...
Companion to [requirements.md](../../MILESTONE_01/shortcuts/requirements.md) and [tasks.md](../../MILESTONE_01/shortcuts/tasks.md).
Implementation handoff lives at [handoff.md](../../MILESTONE_01/shortcuts/handoff.md). Visual prototypes
...
This spec **supersedes** [`keyboard-shortcuts-view/design.md`](../../MILESTONE_01/keyboard-shortcuts-view/design.md)
for the **`⌘/`** trigger:
...
- E2e acceptance criteria: [S-10](../../MILESTONE_01/shortcuts/requirements.md#requirement-s-10-end-to-end-acceptance)
  and [e2e Phase 7](../../MILESTONE_01/e2e/tasks.md#phase-7---shortcuts-feature-p1).
...
(see [`app-service-rpc/design.md`](../../MILESTONE_01/app-service-rpc/design.md)). Handlers
...
Normative interaction with [`command-palette-filter-ux`](../../MILESTONE_01/command-palette-filter-ux/requirements.md):
...
`src/shell/renderer/pages/detail/detail.page.tsx` (per [tasks.md](../../MILESTONE_01/shortcuts/tasks.md)
...
- [prototype.overlay.a.html](../../MILESTONE_01/shortcuts/prototype.overlay.a.html) — Variant A,
  Raycast Compact, collision icons inline, frecency-sorted. Default for
  empty input and text mode.
- [prototype.overlay.c.html](../../MILESTONE_01/shortcuts/prototype.overlay.c.html) — Variant C,
  Conflicts-First Cards. Default for chord-mode input.
- [prototype.keymap.html](../../MILESTONE_01/shortcuts/prototype.keymap.html) — keymap detail body
  derived from Variant A's row style.
- [prototype.chord-detail.html](../../MILESTONE_01/shortcuts/prototype.chord-detail.html) — chord
  detail body derived from Variant C's card style.

All four are styled with the existing Andromeda Void + PowerToys-flat
language (see [raycast-redesign/design.md](../../MILESTONE_01/raycast-redesign/design.md) for
