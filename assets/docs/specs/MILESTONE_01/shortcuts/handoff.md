...
- [requirements.md](../../MILESTONE_01/shortcuts/requirements.md) — EARS-style acceptance criteria, S-1
  through S-9 (S-4 carries §§ 1–17 for the overlay including the centred
  filter dropdown).
- [design.md](../../MILESTONE_01/shortcuts/design.md) — architecture, data model, collision rules,
  RPC, renderer surfaces, prototype references, out-of-scope.
- [tasks.md](../../MILESTONE_01/shortcuts/tasks.md) — task-by-task implementation plan with file paths
  and commit messages.
- [prototype.overlay.a.html](../../MILESTONE_01/shortcuts/prototype.overlay.a.html),
  [prototype.overlay.c.html](../../MILESTONE_01/shortcuts/prototype.overlay.c.html),
  [prototype.keymap.html](../../MILESTONE_01/shortcuts/prototype.keymap.html),
  [prototype.chord-detail.html](../../MILESTONE_01/shortcuts/prototype.chord-detail.html) — visual
  ground-truth for the four UI states.

## Mode of execution

For each task, use `subagent-driven-development` to
work [tasks.md](../../MILESTONE_01/shortcuts/tasks.md) one task at a time. Tasks are ordered to keep
...
| 18  | **E2e is part of Definition of Done** — Task 21 + [e2e Phase 7](../../MILESTONE_01/e2e/tasks.md#phase-7---shortcuts-feature-p1). Feature/refactor specs MUST ship Gherkin scenarios before beta.                                                                                                                               |
...
[`assets/docs/specs/e2e/fixture-manifest.md`](../../MILESTONE_01/e2e/fixture-manifest.md),
[`assets/docs/specs/e2e/step-catalog.md`](../../MILESTONE_01/e2e/step-catalog.md).

**E2e policy:** every release-facing feature (including shortcuts) MUST satisfy
[requirements.md S-10](../../MILESTONE_01/shortcuts/requirements.md#requirement-s-10-end-to-end-acceptance)
and the cross-feature rule in [e2e/requirements.md R11](../../MILESTONE_01/e2e/requirements.md#r11---cross-feature-e2e-acceptance).

## What success looks like

The Definition-of-Done checklist in [tasks.md § Task 20](../../MILESTONE_01/shortcuts/tasks.md#task-20--definition-of-done)
is the evidence ledger. Normative pass/fail criteria live in
[requirements.md](../../MILESTONE_01/shortcuts/requirements.md):
...
- **S-3 AC8** + **S-4 AC9** + **S-10 AC10** — YAML sync reports hard global
  ...
  [`shortcuts_import.feature`](../../MILESTONE_01/features/e2e/shortcuts_import.feature)).
...
| Shortcut logic added to `detail_view` instead of `detail.page` | Tasks 13–14 wire `detail.page.tsx`; see [design.md § Detail page orchestration](../../MILESTONE_01/shortcuts/design.md#detail-page-orchestration-tasks-1314). |
...
**Status table:** [tasks.md § Remaining tasks (agent entry point)](../../MILESTONE_01/shortcuts/tasks.md#remaining-tasks-agent-entry-point) — repo audit dated 2026-05-27; refresh if your branch diverges.
...
**Checkbox drift:** If `tasks.md` marks a task done but the [audit table](../../MILESTONE_01/shortcuts/tasks.md#remaining-tasks-agent-entry-point) says **Partial**, finish **integration** sub-bullets first.
...
finish integration per [design.md § Detail page orchestration](../../MILESTONE_01/shortcuts/design.md#detail-page-orchestration-tasks-1314).
