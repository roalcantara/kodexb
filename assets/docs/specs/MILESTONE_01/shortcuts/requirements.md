...
[design.md](../../MILESTONE_01/shortcuts/design.md) and one or more tasks in [tasks.md](../../MILESTONE_01/shortcuts/tasks.md).
...
prose — see [`assets/docs/specs/README.md`](../../MILESTONE_01/README.md#verifiable-acceptance-no-orphan-checks).
...
7. WHEN the renderer requests collisions for a candidate chord, THEN the
   ...
   lookup using the indexes defined in [design.md](../../MILESTONE_01/shortcuts/design.md) § 3.
...
5. WHEN the user types text that parses as a chord (≥ 1 modifier glyph/word
   ...
   (per [design.md](../../MILESTONE_01/shortcuts/design.md) § 5).
...
2. WHEN e2e fixture seeding runs, THEN it SHALL import
   `shortcuts/release.yml` per [`e2e/fixture-manifest.md`](../../MILESTONE_01/e2e/fixture-manifest.md)
...
4. WHEN overlay scenarios run, THEN they SHALL assert user-visible outcomes
   ...
   using steps registered in [`e2e/step-catalog.md`](../../MILESTONE_01/e2e/step-catalog.md).
...
7. WHEN shortcuts tasks are complete, THEN evidence SHALL be recorded in
   [`e2e/tasks.md` Phase 7](../../MILESTONE_01/e2e/tasks.md#phase-7---shortcuts-feature-p1)
...
8. WHEN a maintainer validates shortcuts in the preview harness, THEN
   ...
   [design.md](../../MILESTONE_01/shortcuts/design.md) § Preview) SHALL expose all four UI states using
   **real renderer components** (not static prototype HTML): quick-lookup
   ...
   keymap.
   - **Measure:** follow the preview checklist in [tasks.md Task 20](../../MILESTONE_01/shortcuts/tasks.md#task-20--definition-of-done)
     (prototype filenames in [design.md](../../MILESTONE_01/shortcuts/design.md) § Prototypes are visual
...
9. WHEN shortcuts is declared beta-ready, THEN every numbered AC in S-1
   ...
   [tasks.md](../../MILESTONE_01/shortcuts/tasks.md) with recorded verification evidence (unit spec, e2e
...
| S-8 Config              | § 6                                                                                | T18           |
| S-9 OS seed             | § 3 § 6                                                                            | T17           |
| S-10 E2e acceptance     | § 4, [e2e Phase 7](../../MILESTONE_01/e2e/tasks.md#phase-7---shortcuts-feature-p1) | T21, e2e T7.x |
