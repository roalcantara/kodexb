...
list-page integration, per [design.md](../../MILESTONE_01/shortcuts/design.md).
...
**Execution order:** [handoff.md § Remaining work order](../../MILESTONE_01/shortcuts/handoff.md#remaining-work-order-agent).
...
- [x] Read [requirements.md](../../MILESTONE_01/shortcuts/requirements.md), [design.md](../../MILESTONE_01/shortcuts/design.md), and
...
- [x] Schema per [design.md § 1](../../MILESTONE_01/shortcuts/design.md#-1--data-model). Export
...
- [x] `BindingRef` and `Collision` types per [design.md § 2](../../MILESTONE_01/shortcuts/design.md#-2--collision-detection).
...
- [x] Add the Raycast-style filter chip on the right of the search input
      ...
      [requirements.md](../../MILESTONE_01/shortcuts/requirements.md) S-4 §§ 11–17 and
      [design.md § 4 — Filter chip + centred modal dropdown](../../MILESTONE_01/shortcuts/design.md#filter-chip--centred-modal-dropdown-raycast-style)):
...
- `src/shell/renderer/pages/detail/detail.page.tsx` (dispatch by entry type;
  see [design.md § Detail page orchestration](../../MILESTONE_01/shortcuts/design.md#detail-page-orchestration-tasks-1314) —
...
- [x] `detail.page.tsx` branches on `entry.type === 'shortcut'` and renders
      `ShortcutKeymap` (see [design § Detail page orchestration](../../MILESTONE_01/shortcuts/design.md#detail-page-orchestration-tasks-1314)).
...
- [ ] All acceptance criteria from
      [requirements.md](../../MILESTONE_01/shortcuts/requirements.md) traceable to tasks above.
...
[e2e T2.4](../../MILESTONE_01/e2e/tasks.md) (test profile). Feature files may exist with `@todo`
while UI is in flight — remove `@todo` only when scenarios pass.

**Agent workflow:**

1. Read [e2e/step-catalog.md](../../MILESTONE_01/e2e/step-catalog.md) — every Gherkin phrase
   must appear before implementing steps.
2. Align fixture titles with [e2e/fixture-manifest.md](../../MILESTONE_01/e2e/fixture-manifest.md)
...
- [x] Remove `@todo` from release-gate scenarios when green; record evidence
      in [e2e/tasks.md Phase 7](../../MILESTONE_01/e2e/tasks.md#phase-7---shortcuts-feature-p1).
...
_See [requirements.md S-10](../../MILESTONE_01/shortcuts/requirements.md#requirement-s-10-end-to-end-acceptance)._
