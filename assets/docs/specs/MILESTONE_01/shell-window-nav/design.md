...
Visual reference (non-normative mock): [`prototype-shell-states.html`](../../MILESTONE_01/shell-window-nav/prototype-shell-states.html).

Related prior note: [`../renderer-nav-flow/handoff.md`](../../MILESTONE_01/renderer-nav-flow/handoff.md) (document-level key listeners vs Electrobun webview).
...
- Prototype: [`prototype-shell-states.html`](../../MILESTONE_01/shell-window-nav/prototype-shell-states.html).
- Implementation plan: [`implementation-plan.md`](../../MILESTONE_01/shell-window-nav/implementation-plan.md).
