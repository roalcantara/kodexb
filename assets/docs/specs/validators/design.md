...
- [`../foundation/design.md`](../foundation/design.md) — Decision 2 to be
  inverted by this refactor.
- [`../foundation/roadmap.md`](../foundation/roadmap.md) — Phase 3 row to be
  updated.
- [`../core-domain/design.md`](../core-domain/design.md) — original Phase 3
