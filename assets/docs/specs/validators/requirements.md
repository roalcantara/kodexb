...
Traceability: each **REQUIREMENT V-*** block maps to [design.md](design.md)
and to ordered work in [tasks.md](tasks.md).
...
- [design.md](design.md) — normative technical contract.
- [tasks.md](tasks.md) — ordered implementation work.
- Foundation specs — [`../foundation/design.md`](../foundation/design.md),
  [`../foundation/requirements.md`](../foundation/requirements.md),
  [`../foundation/roadmap.md`](../foundation/roadmap.md).
- Phase 3 spec — [`../core-domain/design.md`](../core-domain/design.md),
  [`../core-domain/tasks.md`](../core-domain/tasks.md).
