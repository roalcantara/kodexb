...
| :-------: | :--------: | ------- | ------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------- | :---------: |
|     1     |    [ ]     | 🄷 8     | 1/2. Preserve frecency across sync (preserve tables or split DB)                      | [01_sync-frecency-persistence](01_sync-frecency-persistence/requirements.md)    |   v0.10.0   |
|     2     |    [ ]     | 🄷 8     | 2/1. Task writes: YAML-first or fail RPC; stop swallowing errors                      | [02_task-source-truthfulness](02_task-source-truthfulness/requirements.md)      |   v0.10.0   |
|     3     |    [ ]     | 🄷 5     | 3/3. Tag facets: single SQL `json_each` aggregate                                     | [03_list-tag-facet-performance](03_list-tag-facet-performance/requirements.md)  |   v0.10.0   |
...
Use [`_templates/handoff.template.md`](_templates/handoff.template.md) when switching agents mid-spec.
...
2. Reviewer loads [`_templates/review.template.md`](_templates/review.template.md).
...
- [Handoff template](_templates/handoff.template.md) — skill: `session-handoff` / `handoff` optional
- [Review template](_templates/review.template.md) — skill: `app-quality-gate`, `receiving-code-review`
