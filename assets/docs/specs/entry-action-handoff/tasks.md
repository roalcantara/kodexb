...
## Fixup 2 verification (2026-06-01)

```text
$ CI=1 bun run e2e:regression --grep entry_action_handoff --retries=0

Running 11 tests using 1 worker

  ✓ Footer shows Open In Browser for a bookmark ...
  ✓ Footer shows Paste and Run in Terminal for a command ...
  ✓ Footer shows Paste Doc for a cheat ...
  ✓ Bookmark primary requests external open handoff ...
  ✓ Command primary requests paste in terminal handoff ...
  ✓ Command secondary requests run in terminal handoff ...
  ✓ Cheat primary requests paste doc handoff ...
  ✓ Copy Title shortcut shows success feedback ...
  ✓ Copy Description shortcut shows success feedback ...
  ✓ Open Source shortcut requests editor handoff ...
  ✓ Handoff failure shows error toast ...

  11 passed (9.0s)
```

`gate.sh` green. `scenario-scores.json` updated (`passing` for all 11). Zero flaky, zero failed.
Precondition: handoff intercept active, regression fixture data loaded.
