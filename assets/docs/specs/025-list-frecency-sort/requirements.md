...
Rank **entry rows** in List View and Split View by **frecency** (frequency + recency), similar to [Raycast `useFrecencySorting`](https://developers.raycast.com/utilities/react-hooks/usefrecencysorting). Normative contract: [design.md](design.md).

**Supersedes** foundation [V1-3 acceptance #1](../foundation/requirements.md) (type → alphabetical browse order) for list display.
