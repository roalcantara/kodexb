...
- [CI review e2e](ci-review-e2e/design.md) — parallel smoke and regression jobs in review.yml; [requirements](ci-review-e2e/requirements.md), [tasks](ci-review-e2e/tasks.md), [handoff](ci-review-e2e/handoff.md).
...
- [Electrobun corpus audit](electrobun-corpus-audit/report.md) — full upstream doc coverage, adoption tiers, inventory refresh; [handoff](electrobun-corpus-audit/handoff.md).
...
- [Electrobun Utils Adoption](electrobun-utils-adoption/handoff.md) — Phases 1–3: boolean `openExternal`/`openPath` handling, cursor-aware Screen API, event-driven shortcut teardown; [inventory](../elysia-electrobun-capability-inventory/inventory.yml).
