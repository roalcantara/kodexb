...
scope** for v1 (see [`entry-action-handoff/requirements.md`](../entry-action-handoff/requirements.md)).
...
remains normative in [`entry-action-handoff/`](../entry-action-handoff/),
[`shell-window-nav/`](../shell-window-nav/), [`shortcuts/`](../shortcuts/), etc.
...
**Traceability:** [`entry-action-handoff`](../entry-action-handoff/requirements.md) R3, design §Browser.
...
**Traceability:** [`shell-window-nav`](../shell-window-nav/requirements.md) R2–R3.

1. WHEN app launches on Linux THEN window **SHALL** open centered on cursor display
   (or primary fallback) — same as macOS ([`electrobun-utils-adoption`](../electrobun-utils-adoption/) R3).
...
2. WHEN `@regression` e2e is green THEN hard-gate `--metrics-compare` **SHALL** pass
   ([`ci-review-e2e`](../ci-review-e2e/requirements.md) R4).
...
1. WHEN parity gaps close THEN **SHALL** update [`entry-action-handoff/tasks.md`](../entry-action-handoff/tasks.md)
   (remove stale “macOS-only” notes), [`entry-action-handoff/handoff-fixup.md`](../entry-action-handoff/handoff-fixup.md),
