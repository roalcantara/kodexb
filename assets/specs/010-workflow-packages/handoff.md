...
| WEP-5 AC1  | WORKFLOW_RUNTIME_GUIDE.md documents `@kb/workflow-core` / `@kb/workflow-runtime` and governance CLI seams                | `mise run spec lint assets/specs/010-workflow-packages`                                                  |
