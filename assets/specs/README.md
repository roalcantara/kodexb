...
| [`009-agentic-workflow-orchestrator/`](009-agentic-workflow-orchestrator/) | **Shipped** — program merged on `main`; engine in `packages/workflow-*`                                              |
| [`010-workflow-packages/`](010-workflow-packages/)                         | **Shipped** — workspaces + PROFILE-SDD-01 / SMOKE-01 (partial; completed by 012)                                     |
