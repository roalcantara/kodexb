...
const DEFAULT_OUTPUT = path.join(ROOT, 'tools/metrics/fixtures/perf/workflow-observability-feature.json')
const ABSOLUTE_PATH_RE = /\/(Users|home|etc|var)\/[A-Za-z0-9_./-]+/g

function usage(): string {
  return 'Usage: bun tools/metrics/harnesses/perf/workflow_observability_extract_dataset.script.ts --feature <dir> [--output <path>]'
}
