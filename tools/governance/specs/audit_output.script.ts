...
import {
  ...
  gumTitle,
  gumWarn
} from '../../support/lib/cli/gum_theme.script.ts'
import { chooseRenderer, type RenderMode } from '../../support/lib/cli/render_mode.script.ts'
import type { AuditResult } from './audit_core.script.ts'

export type { RenderMode } from '../../support/lib/cli/render_mode.script.ts'
export { chooseRenderer } from '../../support/lib/cli/render_mode.script.ts'
