 ...
 *
 * Usage:
 *   bun tools/governance/specs/feature_init.script.ts --id 001 --slug sync-frecency-persistence
 */
...
async function main(): Promise<void> {
  ...
  if (!id || !slug) {
    console.error('usage: bun tools/governance/specs/feature_init.script.ts --id 001 --slug my-feature')
    process.exit(2)
  }
