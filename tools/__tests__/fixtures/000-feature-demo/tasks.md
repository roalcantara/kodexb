...
| 9   | mkdtempSync fixtures in `orchestrated_handoff.script.spec.ts` covering WOBS-2 paths | New tests do not read `tools/__tests__/fixtures/003-sync-frecency-preserve/`                                      | WOBS-2 (spec note) |
