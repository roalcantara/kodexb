 ...
 *   KB_PLACEMENT_PROBE=1 bun tools/dev/launcher_placement_probe.script.ts --probe
 *
...
import { LAUNCHER_PROBE_PATH, type LauncherProbePayload } from '../../src/shell/main/window/launcher_frame_probe.util'
import {
