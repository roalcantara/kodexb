...
import type { EntryActionPanelDeps } from '../../shell/renderer/actions/entry_action_panel_deps.util'
...
export function installEntryActionPanelDepsMock(): EntryActionPanelDeps {
  ...
  mock.module('../../shell/renderer/actions/entry_action_panel_deps.util', () => ({
